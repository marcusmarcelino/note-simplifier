...
public class NoteSimplifierApplication {
	...
	CommandLineRunner run(
		...
		return args -> {
			...
			roleService.save(new Role(null, "ROLE_PROFESSIONAL"));
			...
			normal_user.setAccountStatus(AccountStatus.active);
			...
			user_admin.setAccountStatus(AccountStatus.active);
			...
			user_super_admin.setAccountStatus(AccountStatus.active);
			...
			user_seller.setAccountStatus(AccountStatus.active);
			...
			professional_user_provider.setAccountStatus(AccountStatus.active);
			...
			product1.setType(ProductType.UN);
			...
			product2.setType(ProductType.CX);
			...
			product3.setType(ProductType.UN);
			...
			product4.setType(ProductType.CX);
			...
			paymentForServiceProvided.setSituation(PaymentSituation.PROCESSING);
			paymentForServiceProvided.setDate(LocalDate.now());

			ServiceProvided serviceProvided = new ServiceProvided();
			serviceProvided.setServiceDescription("Serviço realizado");
			serviceProvided.setSituation(ProgressStatus.IN_PROGRESS);
